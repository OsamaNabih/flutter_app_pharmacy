...
class drug {
  ...
  void populateDb(Database database, int version) async {
    await database.execute(
        "CREATE TABLE drug (id INTEGER PRIMARY KEY,drug_name TEXT,quantity INTEGER ,price TEXT,client_id  INTEGER)");
    print("done");
  }
...
void pro() async {
  drug l =
      drug(id: 1, drug_name: "flu", quantity: 2, price: "55", client_id: 2);
